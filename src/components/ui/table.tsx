...
const tableStyles = {
  table: '[&_.rc-table-content]:overflow-x-auto [&_table]:w-full [&_.rc-table-row:hover]:bg-gray-100/60',
  thead:
  ...
  variants: {
    ...
    modern: '[&_thead]:bg-gray-100/50 [&_td.rc-table-cell]:border-b [&_td.rc-table-cell]:border-gray-100/50',
    minimal: '[&_thead]:bg-muted/50',
    elegant: '[&_thead]:border-y [&_thead]:border-muted [&_td.rc-table-cell]:border-b [&_td.rc-table-cell]:border-muted'
  },
...
export default function RcTable({ striped, variant = 'classic', emptyText, className, ...props }: TableProps) {
  return (
    <Table
      className={cn(
        tableStyles.table,
